...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicianDatabase.Lineup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicianDatabase.LineupBands", b =>
                {
                    ...
                    b.HasKey("LineupId", "BandId");

                    b.HasIndex("BandId");

                    b.ToTable("LineupBands");
                });
            ...
            modelBuilder.Entity("MusicianDatabase.Lineup", b =>
                {
                    b.HasOne("MusicianDatabase.Concert", "Concert")
                        .WithOne("Lineup")
                        .HasForeignKey("MusicianDatabase.Lineup", "ConcertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MusicianDatabase.LineupBands", b =>
                {
                    b.HasOne("MusicianDatabase.Band", "Band")
                        .WithMany("LineupBands")
                        .HasForeignKey("BandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicianDatabase.Lineup", "Lineup")
                        .WithMany("LineupBands")
